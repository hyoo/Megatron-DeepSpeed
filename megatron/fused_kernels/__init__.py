...
def load(args):
    ...
    def _cpp_extention_load_helper(name, sources, extra_cuda_flags):
        return cpp_extension.load(
            ...
            extra_cflags=['-O3', '-D__HIP_PLATFORM_AMD__=1'],
            extra_cuda_cflags=['-O3',
                               # '-gencode', 'arch=compute_70,code=sm_70',
                               # '--use_fast_math']
                               '-D__HIP_PLATFORM_AMD__=1'] + extra_cuda_flags + cc_flag,
            verbose=(args.rank == 0)
        )
    ...
    if args.masked_softmax_fusion:
        ...
        scaled_upper_triang_masked_softmax_cuda = _cpp_extention_load_helper(
            "scaled_upper_triang_masked_softmax_hip",
        ...
        scaled_masked_softmax_cuda = _cpp_extention_load_helper(
            "scaled_masked_softmax_hip", sources, extra_cuda_flags)
    ...
    fused_mix_prec_layer_norm_cuda = _cpp_extention_load_helper(
        "fused_mix_prec_layer_norm_hip", sources, extra_cuda_flags)
